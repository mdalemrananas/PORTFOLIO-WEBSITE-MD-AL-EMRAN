  ...
  return (
    <section id="projects" className="py-16 lg:py-24 overflow-x-hidden">
      <div className="container mx-auto px-6 lg:px-8 max-w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 px-2 sm:px-0">
          {projects.map((project) => (
            <Card
              key={project.id}
              className="p-4 sm:p-6 bg-surface border-card-border hover:shadow-lg transition-all cursor-pointer group w-full"
            >
              <div className="mb-4">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {selectedProject.features.map((feature: string, idx: number) => (
                              <div key={idx} className="flex items-start gap-2 min-w-0">
                                ...
                                <span className="text-sm break-words leading-relaxed">{feature}</span>
                              </div>
                            ))}
                          </div>
                        </div>
